...
Созданы два файла с данными для групп и студентов (не менее 3 групп и 30 студентов). Эти файлы используются при формировании данных групп и студентов

Написана демонстрационная версия приложения
